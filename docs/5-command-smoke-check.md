...
**Step 5 — Update this command**
If a new module was added since this command was last updated, add its API routes to the table in Step 2 and its page to Step 3. If a route's expected shape changed, update the table. Keep the table in sync with `CLAUDE.md` active modules — they should always agree.
